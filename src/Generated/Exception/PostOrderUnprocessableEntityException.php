...
- ORDER_UNKNOWN_VAT_FOR_COUNTRY: A given vat value does not match any known tax rate for the delivery country.
...
- ORDER_DESIRED_SHIPPING_DATE_IN_PAST: The given desiredShippingDate is in the past.
