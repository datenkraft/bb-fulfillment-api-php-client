...
class PostOrderPartialDeliveryConflictException extends ConflictException
{
    /**
...
Error codes:
- ORDER_PARTIAL_DELIVERY_ALREADY_EXISTS: The order is already marked for partial delivery.');
