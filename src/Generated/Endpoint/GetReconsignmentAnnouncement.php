...
class GetReconsignmentAnnouncement extends \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $reconsignmentAnnouncementNumber, array $queryParameters = [])
    {
    ...
    {
        return str_replace(['{reconsignmentAnnouncementNumber}'], [$this->reconsignmentAnnouncementNumber], '/reconsignment-announcement/{reconsignmentAnnouncementNumber}');
    }
