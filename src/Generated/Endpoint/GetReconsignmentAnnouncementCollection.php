...
class GetReconsignmentAnnouncementCollection extends \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['page', 'pageSize', 'paginationMode', 'sortBy', 'filter[shopCode]', 'filter[orderNumber]', 'filter[reconsignmentAnnouncementCompleted]', 'filter[reconsignmentAnnouncementDateFrom]', 'filter[reconsignmentAnnouncementDateTo]', 'filter[search]']);
        ...
        $optionsResolver->addAllowedTypes('filter[reconsignmentAnnouncementCompleted]', ['bool']);
        $optionsResolver->addAllowedTypes('filter[reconsignmentAnnouncementDateFrom]', ['string']);
        $optionsResolver->addAllowedTypes('filter[reconsignmentAnnouncementDateTo]', ['string']);
