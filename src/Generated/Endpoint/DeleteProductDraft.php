...
class DeleteProductDraft extends \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $productDraftId, array $queryParameters = array())
    {
    ...
    {
        return str_replace(array('{productDraftId}'), array($this->productDraftId), '/product-draft/{productDraftId}');
    }
    ...
    protected function getQueryOptionsResolver() : \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setRequired(array('shopCode'));
