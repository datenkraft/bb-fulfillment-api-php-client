...
class GetReconsignmentCollection extends \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['page', 'pageSize', 'paginationMode', 'sortBy', 'filter[shopCode]', 'filter[orderNumber]', 'filter[reconsignmentWasPreAnnounced]', 'filter[search]', 'filter[reconsignmentDateFrom]', 'filter[reconsignmentDateTo]']);
        ...
        $optionsResolver->addAllowedTypes('filter[reconsignmentWasPreAnnounced]', ['bool']);
        $optionsResolver->addAllowedTypes('filter[search]', ['string']);
        $optionsResolver->addAllowedTypes('filter[reconsignmentDateFrom]', ['string']);
        $optionsResolver->addAllowedTypes('filter[reconsignmentDateTo]', ['string']);
