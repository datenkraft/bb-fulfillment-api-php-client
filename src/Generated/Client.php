...
class Client extends \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Runtime\Client\Client
{
    ...
    *    "paginationMode"?: string, //The paginationMode to use:
    ...
    - totalCount: The total number of items in the collection will be calculated.
    This can mean loss of performance.
    *    "filter[productNumber]"?: string, //product number
    *    "filter[shopCode]"?: string, //The shopCode used in DISCO (optional).
    * } $queryParameters
    ...
    */
    ...
    public static function create($httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        if (null === $httpClient) {
            ...
            $plugins = [];
            $uri = \Http\Discovery\Psr17FactoryDiscovery::findUriFactory()->createUri('https://fulfillment-api.steve.niceshops.com/v1');
