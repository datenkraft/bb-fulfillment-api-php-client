...
class CollectionPaginationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Model\CollectionPagination::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Model\CollectionPagination::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Datenkraft\Backbone\Client\FulfillmentApi\Generated\Model\CollectionPagination();
    ...
    {
        return [\Datenkraft\Backbone\Client\FulfillmentApi\Generated\Model\CollectionPagination::class => false];
    }
}