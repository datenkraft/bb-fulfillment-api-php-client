...
class ProductStockReferenceCollection extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<ProductStockReference>
     */
    protected $data;
    /**
    ...
    /**
     * @return list<ProductStockReference>
     */
    ...
    /**
     * @param list<ProductStockReference> $data
     *
     * @return self
     */
